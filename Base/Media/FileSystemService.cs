...
namespace Base.Services.Media
{
    public interface IFileSystemService
    {
        ...
        Task<FileData> SaveFile(Stream file, IUnitOfWork uofw, string fileName, string extension);
    ...
    public class FileSystemService : IFileSystemService
    {
        ...
        public async Task<FileData> SaveFile(Stream file, IUnitOfWork uofw, string fileName, string extension)
        {
            var ret = SaveFile(file, fileName, extension);
            var res = await uofw.GetRepository<FileData>().CreateAsync(ret);
